...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!commandInt) {
      ...
      readdirSync(`./slashsommands/Bot`).forEach((file) => {
        const filen = require(`../../slashsommands/Bot/${file}`);
      ...
      readdirSync(`./slashsommands/Utility`).forEach((file) => {
        const filen = require(`../../slashsommands/Utility/${file}`);
        const name = `\`${filen.name}\``
